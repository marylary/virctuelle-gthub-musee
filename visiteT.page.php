  ...
  <div class="px-lg-5">
    ...
    <div class="row py-5">
      <div class="col-lg-12 mx-auto">
        ...
        <h1 class="display-4">BIENVENUE CHEZ MUSEES TECHNIQUES</h1>
          <br>
          <br>
    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/images.jpg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/vienne.jpeg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/techno3.jpg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/techno2.jpg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/techno1.jpg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/techno.jpg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/nation.jpeg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/depart.jpeg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/celebre.jpeg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
            <h5> <a href="#" class="text-dark">Red paint cup</a></h5>
            <p class="small text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
            <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/biller.jpeg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/autriche.jpeg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
            <h5> <a href="#" class="text-dark">Lorem ipsum dolor</a></h5>
            <p class="small text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
            <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
      ...
      <!-- Gallery item -->
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm"><img src="tecno/art.jpeg" alt="" class="img-fluid card-img-top">
          <div class="p-4">
            <h5> <a href="#" class="text-dark">Lorem ipsum dolor</a></h5>
            <p class="small text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
            <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
